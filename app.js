...
const translations = {
  es: {
    ...
    hero_cta: "Cotizar por WhatsApp",
    evidence_1: "Autos",
    evidence_2: "Sofás",
    evidence_3: "Alfombras",
    evidence_4: "Piscinas",
    proof_1: "Servicio móvil en New York, New Jersey y zonas cercanas",
    proof_2: "Cotización por WhatsApp",
    proof_3: "Trabajos para autos, hogares y negocios",
    ...
    process_1_title: "Envías foto",
    process_1_copy: "Muestra el auto, mueble, alfombra, piscina o área que necesita limpieza.",
    process_2_title: "Recibes estimación",
    process_2_copy: "Luciano Wash revisa el tamaño y la condición del trabajo.",
    process_3_title: "Agendamos el servicio",
    process_3_copy: "Coordinamos fecha, hora y ubicación por WhatsApp.",
    ...
    intro_eyebrow: "Nosotros",
    intro_title: "Limpieza profesional con detalle y confianza.",
    intro_copy: "En Luciano Wash revitalizamos y protegemos cada superficie: vehículos, hogares y espacios laborales. Trabajamos con atención al detalle, productos de calidad y un trato directo para entregar resultados que se notan.",
    about_mission_title: "Misión",
    about_mission_copy: "Ofrecer limpieza y detailing de alta calidad para autos, hogares y negocios, cuidando cada detalle y superando expectativas.",
    about_vision_title: "Visión",
    about_vision_copy: "Ser una empresa reconocida por profesionalismo, confianza y resultados que hacen cada espacio más limpio, brillante y saludable.",
    about_values_title: "Valores",
    about_values_copy: "Calidad, confianza, sostenibilidad, innovación y pasión en cada servicio.",
    services_eyebrow: "Servicios profesionales",
    services_title: "Todo lo que necesitas limpiar, en un solo lugar.",
    quote: "Cotizar",
    service_1_title: "Detailing de autos",
    service_1_copy: "Interior/exterior, motor, descontaminación, corrección de pintura, cerámico y PPF.",
    service_2_title: "Lavado de camiones",
    service_2_copy: "Limpieza para unidades grandes, flotas y vehículos de trabajo.",
    service_3_title: "Muebles, sillones y colchones",
    service_3_copy: "Limpieza profunda para sofás, tapicería, sillones, colchones y piezas de alto uso.",
    service_4_title: "Alfombras",
    service_4_copy: "Restauración visual, extracción de suciedad y mantenimiento programado.",
    service_5_title: "Restauración automotriz",
    service_5_copy: "Plásticos, focos, insignias, descontaminación química/manual y corrección de pintura.",
    service_6_title: "Piscinas",
    service_6_copy: "Limpieza y mantenimiento para agua clara, bordes limpios y espacios listos.",
    ...
    trust_1_title: "Atención en New York, New Jersey y zonas cercanas",
    ...
    service_area: "New York, New Jersey y zonas cercanas",
    ...
    float_quote: "Cotizar por WhatsApp",
    float_quote_mobile: "Enviar foto",
  ...
  en: {
    ...
    hero_cta: "Quote by WhatsApp",
    evidence_1: "Cars",
    evidence_2: "Sofas",
    evidence_3: "Carpets",
    evidence_4: "Pools",
    proof_1: "Mobile service in New York, New Jersey and nearby areas",
    proof_2: "Quote by WhatsApp",
    proof_3: "Work for cars, homes and businesses",
    ...
    process_1_title: "Send a photo",
    process_1_copy: "Show the car, furniture, carpet, pool or area that needs cleaning.",
    process_2_title: "Get an estimate",
    process_2_copy: "Luciano Wash reviews the size and condition of the job.",
    process_3_title: "Book the service",
    process_3_copy: "We coordinate date, time and location by WhatsApp.",
    ...
    intro_title: "Professional cleaning with detail and trust.",
    intro_copy: "At Luciano Wash, we revitalize and protect every surface: vehicles, homes and work spaces. We work with attention to detail, quality products and direct communication to deliver results people can see.",
    about_mission_title: "Mission",
    about_mission_copy: "To provide high-quality cleaning and detailing for cars, homes and businesses, caring for every detail and exceeding expectations.",
    about_vision_title: "Vision",
    about_vision_copy: "To be recognized for professionalism, trust and results that make every space cleaner, brighter and healthier.",
    about_values_title: "Values",
    about_values_copy: "Quality, trust, sustainability, innovation and passion in every service.",
    services_eyebrow: "Professional services",
    services_title: "Everything you need cleaned, in one place.",
    quote: "Quote",
    service_1_title: "Auto Detailing",
    service_1_copy: "Interior/exterior, engine, decontamination, paint correction, ceramic and PPF.",
    service_2_title: "Truck washing",
    service_2_copy: "Cleaning for large vehicles, fleets and work units.",
    service_3_title: "Furniture, armchairs and mattresses",
    service_3_copy: "Deep cleaning for sofas, upholstery, armchairs, mattresses and high-use pieces.",
    service_4_title: "Carpets",
    service_4_copy: "Visual restoration, soil extraction and scheduled maintenance.",
    service_5_title: "Automotive restoration",
    service_5_copy: "Plastics, headlights, emblems, chemical/manual decontamination and paint correction.",
    service_6_title: "Pools",
    service_6_copy: "Cleaning and maintenance for clear water, clean edges and ready-to-use spaces.",
    ...
    trust_1_title: "Serving New York, New Jersey and nearby areas",
    ...
    service_area: "New York, New Jersey and nearby areas",
    ...
    float_quote: "Quote by WhatsApp",
    float_quote_mobile: "Send photo",
