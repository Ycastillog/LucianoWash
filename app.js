...
const translations = {
  es: {
    ...
    services_copy: "Soluciones profesionales para vehículos, hogares, negocios y espacios exteriores.",
    quote: "Cotizar",
    quote_whatsapp: "Cotizar",
    service_group_vehicle: "Vehículos",
    service_group_home: "Hogar y muebles",
    service_group_outdoor: "Exteriores",
    service_group_property: "Hogares y negocios",
  ...
  en: {
    ...
    services_copy: "Professional solutions for vehicles, homes, businesses and outdoor spaces.",
    quote: "Quote",
    quote_whatsapp: "Quote",
    service_group_vehicle: "Vehicles",
    service_group_home: "Home and furniture",
    service_group_outdoor: "Outdoor",
    service_group_property: "Homes and businesses",
