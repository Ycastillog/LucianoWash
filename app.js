...
const translations = {
  es: {
    ...
    trust_1_title: "Atención en NY, Bronx",
    trust_1_copy: "Servicio local para clientes que necesitan respuesta rápida y trato directo.",
  ...
  en: {
    ...
    trust_1_title: "Serving NY, Bronx",
    trust_1_copy: "Local service for customers who need a fast response and direct communication.",
